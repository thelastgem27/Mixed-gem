...
import { Users, CalendarCheck, Wallet, FileBarChart } from "lucide-react";
    ...
    <div className="rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-6 shadow-sm">
      ...
      <div className="grid md:grid-cols-4 gap-4">
        ...
        >
          ...
          <span className="font-medium">HR Report</span>
        </Button>
        ...
        >
          ...
          <span className="font-medium">Operations Summary</span>
        </Button>
      </div>
    </div>
  );
